...
function t7() {
b7_res = b7.filter(i => {
    if (typeof(i) == "string" && i.length > 3) return i;
  });
return b7_res;
}
...
function t9() {
        b9_num = b9.filter(i => typeof(i) == "number");
        b9_string = b9.filter(i => typeof (i) == "string");
...
function t10() {
b10_res = b10.filter(i => i.includes(3));
return b10_res;
}
