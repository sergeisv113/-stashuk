...
// let ar6 =
let ar6 = ['Сергей', 'Skorpion', 31, 'Oktober'];
...
function f16() {
    let out1 = document.querySelector('.out-16-even');
    let out2 = document.querySelector('.out-16-odd');
    for (let i = 0; i < ar16.length; i++) {
        ...
        out1.innerHTML = ar16_even;
        out2.innerHTML = ar16_odd;
    }
}
