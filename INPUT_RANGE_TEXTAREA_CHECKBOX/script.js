...
function f8() {
    ...
    out8.innerHTML = 'Input <input type="" class="i-81">' + '<button class="b-81"></button>';
...
function f19() {
    let text19 = document.querySelector('.i-191');
    let pas19 = document.querySelector('.i-192');
    let out = document.querySelector('.out-19');
    let a = `${text19.value}  ${pas19.value}`;
    out.innerHTML = a;
}
...
function f20(e) {
    ...
    let a = `${form.elements['username'].value}  ${form.elements['password'].value}`;
    out.innerHTML = a;
}
