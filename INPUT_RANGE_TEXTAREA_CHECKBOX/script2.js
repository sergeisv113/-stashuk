...
let out = document.querySelector('div.out-4');
if (i.checked){
    out.innerHTML = 'true';
} else  {
    out.innerHTML =  'false';
...
function f5() {
let out = document.querySelector('div.out-5');
...
function f7() {
let out71 = document.querySelector('div.out-71');
let out72 = document.querySelector('div.out-72');
...
out8.innerHTML = 'Input<input type="" class="i-81">' + '<button class="b-81">Click</button>'
...
function f15() {
let i = document.querySelector('.i-15');
let t = document.querySelector('.t-15');
...
let f = document.querySelector('.s-16');
...
out.innerHTML = i191.value + ' ' + i192.value;
}
