...
function t8() {
    ...
    let num81 = +document.querySelector('.i-81').value;
    let num82 = +document.querySelector('.i-82').value;
    while (num81 <= num82) {
        out.innerHTML += num81 + ' ';
        num81++;
    }
...
function t9() {
    ...
    let start = Math.max(num91, num92);
    let end = Math.min(num91, num92);
    while (end <= start) {
        out.innerHTML += end + ' ';
        end++;
    }
...
function t11() {
    ...
    let i = 0;
    while (i < divs.length) {
        out.innerHTML += divs[i].innerHTML + ' ';
        i++;
    }
}
